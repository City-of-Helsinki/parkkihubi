...
def test_list_endpoint_data(enforcer_api_client, parking_type, parking, disc_parking):
...
def test_registration_number_filter(operator, enforcer_api_client, parking_factory):
...
def test_time_filtering(operator, enforcer_api_client, parking_factory, name):
    p1 = parking_factory(
...
def test_null_time_end_is_replaced_correctly(parking_type, enforcer_api_client, parking, disc_parking):
    parking_object = get_parking_object(parking_type, parking, disc_parking)
